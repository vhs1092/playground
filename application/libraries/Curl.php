...
class Curl {
	...
	private $params = array(); // Populates curl_setopt_array
...
$this->response =$GC_resultVal;
  ...
  echo "</pre>";*/
		...
		if ( ! empty($this->headers))
		{
			...
			$this->option(CURLOPT_HTTPHEADER, TRUE);
		}
	...
	//	$this->response = "response=1&responsetext=TRANSACCION VALIDA&authcode=001&transactionid=000018&avsresponse=U&cvvresponse=P&orderid=111&type=auth&response_code=212&username=oarroyoa101&time=1401990673&amount=288.00000&purshamount=288.0&hash=40a5aa0735ef06552b311745d7c6fffe";
		//return $response; 
		/* echo "<pre>";
