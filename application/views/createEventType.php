...
?>
    ...
    <body>
        <div class="container">
            <form class="form-horizontal" action="saveEventType" method="post" role="form" enctype="multipart/form-data">
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 rowForm">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 rowForm">
                        <div class="col-lg-9 col-md-6 col-sm-6 col-xs-12">
                            <input type="name" class="form-control customField" name="name" id="name" placeholder="Event Name" required>
                        </div>
                    </div>
