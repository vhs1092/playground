...
?>
    ...
    <head>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                if (<?php echo $eventData->latitude;?> > -90 && <?php echo $eventData->latitude;?> < 90 && <?php echo $eventData->longitude;?> > -180 && <?php echo $eventData->longitude;?> < 180) {
                    var isValid = true;
                } else {
                    var isValid = false;
                }
                ...
                if (isValid == false) {
                    ...
                    var latlng = new google.maps.LatLng('<?php echo $eventData->latitude;?>', '<?php echo $eventData->longitude;?>');
    ...
    <body>
        <div class="container">
            <form class="form-horizontal" action="../updateEvent/<?php echo $eventData['event_id'];?>" method="post" role="form" enctype="multipart/form-data">
                <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12 rowForm">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 rowForm">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <input type="name" class="form-control customField" name="name" id="name" value="<?php echo $eventData->name; ?>" placeholder="Event Name">
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <select class="customField" name="event_type_id">
                                <option value="<?php echo $eventData->event_type_id; ?>">
                                <?php if($eventData->event_type_id == null){
                                    echo "";
                                }else{
                                echo $eventData->TypeName;
                               }
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 rowForm">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 rowForm">
                            <textarea class="customField" name="description">   <?php echo $eventData->description; ?></textarea>
                        </div>

                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 rowForm">
                            <label>Event Start Date</label>
                            <input type="date" class="form-control customField" name="start_date" value="<?php echo $eventData->start_date; ?>" placeholder="Event Name">
                        </div>

                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 rowForm">
                            <label>Event Start Time</label>
                            <input type="time" class="form-control customField" name="start_time" value="<?php echo $eventData->start_time; ?>" id="name" placeholder="Event Name">
                        </div>

                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 rowForm">
                            <label>Event End Date</label>
                            <input type="date" class="form-control customField" id="name" value="<?php echo $eventData->end_date; ?>" name="end_date" placeholder="Event Name">
                        </div>

                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 rowForm">
                            <label>Event End Time</label>
                            <input type="time" class="form-control customField" id="name" value="<?php echo $eventData->end_time; ?>" name="end_time" placeholder="Event Name">
                        </div>

                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 rowForm">
                            <label>Event source</label>
                            <input type="text" class="form-control customField" id="name" value="<?php echo $eventData->event_source; ?>" placeholder="Event Source" name="event_source">
                        </div>

                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 rowForm">
                            <label class="col-lg-6 col-md-6 col-sm-6 col-xs-12">Event Price Range</label>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 rowForm">
                                <select name="price" class="theprice" id="<?php echo $eventData->price;?>">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 rowForm">
                    ...
                    <div class="map">
                        ...
                        <input type="hidden" id="latitude" value="<?php echo $eventData->latitude; ?>" name="latitude" placeholder="Latitude" />
                        <input type="hidden" id="longitude" value="<?php echo $eventData->longitude; ?>" name="longitude" placeholder="Longitude" />
